...
<!-- 스크린샷: Knowledge Growth 상단 바 — 4축 요약 (패턴 탐지 1건 승인, 답변 품질 20%, 추론 커버리지, 비용) -->
...
<!-- 스크린샷: Knowledge Growth 상세 — 답변 품질 추이 차트 (세션별 discovered_usage 변화, 승인 시점에 점프) -->
...
<!-- 스크린샷: Before/After 답변 비교 — 같은 질문의 승인 전(각각 따로 설명) vs 승인 후(lift=1.55 시너지 근거) -->

<!-- 스크린샷: 제안된 관계 테이블 — 비건→무기자차 SYNERGY lift=1.55 [approved] + 승인/거부 버튼 -->
